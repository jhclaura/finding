...
export default class CreatureCreator {
  ...
  createGeometryByType(type) {
    ...
    switch (type) {
      case 'box':
        return (newGeo = new THREE.BoxBufferGeometry(
          this.baseScale.x,
          this.baseScale.y,
          this.baseScale.z,
        ))
      ...
      case 'sphere':
        return (newGeo = new THREE.SphereBufferGeometry(
          this.baseRadius,
          15,
          15,
        ))
      ...
      case 'cylinder':
        return (newGeo = new THREE.CylinderBufferGeometry(
          this.baseRadius,
          this.baseRadius,
          this.baseHeight,
          10,
      ...
      case 'cone':
        return (newGeo = new THREE.ConeBufferGeometry(
          this.baseRadius,
          this.baseHeight,
          10,
        ))
  ...
  createShapeByType(type) {
    ...
    switch (type) {
      ...
      case 'cylinder':
        newShape = this.ammo.createCylinderShape(
          this.baseRadius,
          this.baseHeight,
        )
        break
