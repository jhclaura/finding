...
export default class LazyDude extends Character {
      ...
      methods: {
        ...
        onAware: () => {
          ...
          this.prepareCrossFade(
            ...
            this.actionDictionary.struggle,
            0.5,
          )
          setTimeout(() => {
            console.log('dong!')
  ...
  afterModelLoaded() {
    ...
    this.headShape = this.ammo.createShapeFromBuffergeometry(
      this.lazyFace.geometry,
    )
    this.headBody = this.ammo.createRigidBody(
      this.headHolder,
      this.headShape,
      50,
      this.headPosition,
    ...
    this.bellyBody = this.ammo.createRigidBody(
      this.bellyHolder,
      this.bellyShape,
      50,
      this.bodyPosition,
      this.bellyHolder.quaternion,
    )
    ...
    this.leftHandBody = this.ammo.createRigidBody(
      this.leftHandHolder,
      this.sphereShape,
      50,
      this.leftHandPosition,
      this.leftHandHolder.quaternion,
    )
    ...
    this.rightHandBody = this.ammo.createRigidBody(
      this.rightHandHolder,
      this.sphereShape,
      50,
      this.rightHandPosition,
      this.rightHandHolder.quaternion,
    )
  ...
  startEating() {
    this.eatInterval = setInterval(() => {}, 500)
  }
